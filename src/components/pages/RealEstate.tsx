...
const RealEstate = () => {
  return (
    <div>
                ...
                <div className="lg:ps-20 p-10">
                    ...
                    <h1 className="text-white text-4xl font-bold pt-36 product-font">Discover
                      Your Amazing Building....</h1>
            ...
            <div className="realestate-content lg:px-25 p-10 py-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="bg-white rounded-lg shadow-md overflow-hidden p-10 hover:scale-105 transition-transform duration-300 hover:shadow-xl">
                        <h1 className='text-center text-2xl opacity-75'>Instalment Booking</h1>
                        <div className="p-4">
                          <p className='text-center'>Property installment booking, also known as property installment plan or property installment scheme</p>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-md overflow-hidden p-10 hover:scale-105 transition-transform duration-300 hover:shadow-xl">
                        <h1 className='text-center text-2xl opacity-75'>Property Management</h1>
                        <div className="p-4">
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden p-10 hover:scale-105 transition-transform duration-300 hover:shadow-xl">
                        <h1 className='text-center text-2xl opacity-75'>Lifetime Membership</h1>
                        <div className="p-4">
  ...
  <div className="realestate-cities lg:px-25 p-10 py-20 bg-gray-100">
  <h1 className='text-3xl font-bold pb-1'>Find Properties in These Cities</h1>
        ...
        <div className="image-sec relative">
          <img src={img1} alt="" className="w-full h-full object-cover" />
             ...
             {/* grid use three column layout */}
              <div className="realestate-services lg:px-25 p-10 py-20">
              ...
              {/* new feature section */}
              <div className="realestate-feature lg:px-25 p-10 py-20 bg-gray-100">
              ...
              {/* Our Aminities */}
              <div className="our-aminities p-10">
                    ...
                    <div className="w-full md:w-1/2 md:flex items-center">
                         <div className="p-3">
                             ...
                             <p>
                              ...
                              adipisicing elit. Dicta neque explicabo, 
                              dolores nisi natus pariatur! Harum similique
                               dicta impedit excepturi, nihil error quod et 
                               ad architecto sint perspiciatis iure doloremque?
                              Lorem ipsum dolor sit amet consectetur 
                              adipisicing elit. Dicta neque explicabo, 
                              dolores nisi natus pariatur! Harum similique
                               dicta impedit excepturi, nihil error quod et 
